...
public class AppTest {
    ...
    public void shouldCreateContact() {
        contactManager.addContact("John", "Doe", "9123456789");
    ...
    public void shouldThrowRuntimeExceptionWhenFirstNameIsNull() {
        Assertions.assertThrows(RuntimeException.class, () -> {
            contactManager.addContact(null, "Doe", "9123456789");
        });
    }
    ...
    class ParameterizedTests {
        ...
        @ParameterizedTest
        @ValueSource(strings = {"9123456789", "9123456798", "9123456897"})
        ...
        @ParameterizedTest
        @CsvSource({"9123456789", "9123456798", "9123456897"})
    ...
    private static List<String> phoneNumberList() {
        return Arrays.asList("9123456789", "9123456798", "9123456897");
    }
